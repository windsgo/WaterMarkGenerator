...
/*!
    ...
    */
QExifImageHeader::QExifImageHeader(const QExifImageHeader &rhs)
{
    this->readOk = rhs.readOk;
    this->exifHeaderId = rhs.exifHeaderId;

    d = new QExifImageHeaderPrivate();
    *(this->d) = *(rhs.d);
}

QExifImageHeader &QExifImageHeader::operator=(const QExifImageHeader &rhs)
{
    delete d;
